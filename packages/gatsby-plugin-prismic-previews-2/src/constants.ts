...
export const TYPE_PATHS_MISSING_NODE_MSG =
  'The type paths store for this repository could not be found. Check that you have `gatsby-source-prismic` configured with the same repository name in `gatsby-node.js`.'
