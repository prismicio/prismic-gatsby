...
const PrismicLogo = (props: React.SVGProps<SVGSVGElement>): JSX.Element => (
...
export const Modal = ({
  ...
  return (
    <div
      className={[styles.modal, variant === 'red' && styles.modalRed]
        .filter(Boolean)
        .join(' ')}
      data-prismic-repository-name={repositoryName}
      {...variant}
    >
      ...
      <PrismicLogo className={styles.prismicLogo} />
      <div>{children}</div>
    </div>
  )
}
