...
/**
 * Validate a preview token for a specific repository. Two styles of preview
 * refs are checked:
 *
 ...
 * {
 * 	"_tracker": "someHash",
 * 	"<repositoryName>.prismic.io": { "preview": "someValue" }
 * }
 * ```
 *
 ...
 *
 * @returns An `Either` containing an error explaining why it doesn't validate, or `true`.
 */
